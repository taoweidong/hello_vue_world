<template>
  <div>
    <el-card>
      <div slot="header">
        <Icon type="md-aperture" size="30" color="#2e71ea" /><span
          class="clearfix"
          >今日头条</span
        >
        ...
        <Form ref="searchForm" :model="searchForm" inline class="search-form">
          <FormItem prop="date">
            ...
            >
              <el-option
                v-for="(item, index) in dateSelectList"
                :key="index"
                :value="item"
                >{{ item }}</el-option
              >
          ...
          <el-row :gutter="50">
            <el-col :span="6">
              <FormItem prop="mediaAccount">
                <span>媒体账号</span>
                <el-select
                  v-model="searchForm.mediaAccount"
                  filterable
                  placeholder="请选择媒体账号"
                >
                  <el-option value="全部媒体账号">全部媒体账号</el-option>
                  <el-option
                    v-for="(item, index) in mediaAccountList"
                    :key="index"
                    :value="item"
                    >{{ item }}</el-option
                  >
        ...
        <el-card style="margin-top: 30px">
              ...
              <el-row :gutter="10">
                <el-col :span="8">
                  <FormItem prop="applicationTop">
                    <el-select
                      v-model="searchFormTop.applicationTop"
                      filterable
                      placeholder="请选择应用"
                    >
                ...
                <el-col :span="8">
                  <FormItem prop="mediaTypeTop">
                    <el-select
                      v-model="searchFormTop.mediaTypeTop"
                      filterable
                      placeholder="请选择媒体"
                    >
                      <el-option
          ...
          <div>
            <el-table :data="tableDataTopAd" border>
              ...
              ></el-table-column>
              <el-table-column
                v-for="(item, index) in columnTopAd"
                :key="index"
                :prop="item.prop"
                :label="item.label"
                align="center"
        ...
        <el-card style="margin-top: 30px">
              ...
              <el-row :gutter="10">
                <el-col :span="8">
                  <FormItem prop="applicationTop2">
                    <el-select
                      v-model="searchFormTop.applicationTop2"
                      filterable
                      placeholder="请选择应用"
                    >
                      <el-option value="全部应用">全部应用</el-option>
                ...
                <el-col :span="8">
                  <FormItem prop="mediaTypeTop2">
                    <el-select
                      v-model="searchFormTop.mediaTypeTop2"
                      filterable
                      placeholder="请选择媒体"
                    >
                      <el-option
                ...
                <el-col :span="8">
                  <FormItem prop="dateTop2">
                    <el-select
                      v-model="searchFormTop.dateTop2"
                      filterable
                      placeholder="请选择日期"
                    >
                      <el-option
          ...
          <div>
            <el-table :data="tableDataTopIdea" border>
              ...
              ></el-table-column>
              <el-table-column
                v-for="(item, index) in columnTopIdea"
                :key="index"
                :prop="item.prop"
                :label="item.label"
                align="center"
